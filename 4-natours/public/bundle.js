...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW51c2htYXJrIiwiYSI6ImNranNnbjhrdTd5OGoyc2xnMm1jOHltZm8ifQ.uShbrbaiJqCjBAHn_xTCqw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/anushmark/ckjsofvvi5jzz19qg94vxaknd',
    scrollZoom: false // center: [-121.908898,37.314025 ],
    // zoom: 4,
    //interactive: false,

  }); //how to automatically figure out the position of the map based on our tour location points.

  var bounds = new mapboxgl.LngLatBounds(); //loop through all our locations
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updating successfully"));
            }
...
var stripe = Stripe('pk_test_51ICJXBI9C3iXbrPR39Py58N8S7l3pa8DYRO9VlYRKT211BD3eNLiNyQ9Iae499R2R70bhDG81mjW8jMflb4PqYDE00o4nZZ4Cb');
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); //updating user settings
